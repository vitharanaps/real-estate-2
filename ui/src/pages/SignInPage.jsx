...
import { signInValidaitionSchema, signUpValidaitionSchema } from "@/lib/validation";

const SignIpPage = () => {
  // 1. Define your form.
  const form = useForm({
    resolver: zodResolver(signInValidaitionSchema),
    defaultValues: {
      email: "",
      password: "",
    },
  ...
  return (
    <div className="flex h-full w-full flex-col gap-7 ">
      ...
      <div className=" flex flex-col items-center justify-center w-full h-[calc(100vh-120px)] space-y-4 ">
        ...
        you have't an Account Please sign Un..
      </div>
